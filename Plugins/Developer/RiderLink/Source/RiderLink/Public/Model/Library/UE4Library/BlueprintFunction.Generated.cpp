...
namespace JetBrains::EditorPlugin
{
	...
	// identify
	// getters
	const UClass& BlueprintFunction::get_class() const
	{
		return *class_;
	}

	const FString& BlueprintFunction::get_name() const
	{
		return name_;
	}
	...
	// intern
	// equals trait
	bool BlueprintFunction::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const BlueprintFunction&>(object);
